...
int Grid::getFCost(int r, int c)
{
	if (getNode(r,c) != NULL)
		return fCosts[r][c];
}

int Grid::getGCost(int r, int c)
{
	if (getNode(r,c) != NULL)
		return gCosts[r][c];
}
	
int Grid::getHCost(int r, int c)
{
	if (getNode(r,c) != NULL)
		return hCosts[r][c];
}
	
int Grid::onWhichList(int r, int c)
{
	if (getNode(r,c) != NULL)
		return whichList[r][c];
}
	
GridNode* Grid::getParent(int r, int c)
{
	if (getNode(r,c) != NULL)
		return parents[r][c];
}